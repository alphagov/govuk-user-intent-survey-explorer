...
RSpec.configure do |config|
  ...
  #   Elasticsearch::Extensions::Test::Cluster.start(port: ENV["ELASTIC_SEARCH_PORT"], number_of_nodes: 1, timeout: 120, quiet: false) unless Elasticsearch::Extensions::Test::Cluster.running?(on: ENV["ELASTIC_SEARCH_PORT"])
  # end
  #
  # # Stop elasticsearch cluster after test run
  # config.after :suite do
  #   Elasticsearch::Extensions::Test::Cluster.stop(port: ENV["ELASTIC_SEARCH_PORT"], number_of_nodes: 1) unless Elasticsearch::Extensions::Test::Cluster.running?(on: ENV["ELASTIC_SEARCH_PORT"])
  # end
